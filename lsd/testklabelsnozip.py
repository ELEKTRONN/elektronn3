...
lsd_transformer = LSDGaussVdtCom()
loader = KnossosLabelsNozip(conf_path_label = conf_path_labels, conf_path_raw_data = conf_path_raw, patch_shape=(50,50,50),transform=lsd_transformer, raw_mode="caching")
