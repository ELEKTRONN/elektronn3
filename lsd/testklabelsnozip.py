...
loader = KnossosLabelsNozip(conf_path_label = conf_path_labels, conf_path_raw_data = conf_path_raw, patch_shape=(50,50,50),transform=train_transform, raw_mode="caching")
